  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'fadeSlideDown': 'fadeSlideDown 2s 0.5s cubic-bezier(0, 0.5, 0, 1) forwards',
        ...
        'downArrow': 'downArrow 2s 2s cubic-bezier(0.075, 0.82, 0.165, 1) forwards, pulse 1.5s ease-in-out 3s infinite',
      },
    },
  },
};
