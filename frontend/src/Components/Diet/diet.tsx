  ...
  return (
    <div className="bg-[#f5f5f5] ">
      <div className="text-center *:my-2 mt-2">
        ...
        <div>
          <span className="text-gray-500 text-lg lg:px-10 leading-relaxed">
...
const DietCard = () => {
  return (
    <div className="w-[300px]  bg-white rounded-xl p-2 hover:-translate-y-3  hover:shadow-xl transition-all duration-500  hover:outline-indigo-400 group">
      <div className="w-fit">
        <img
          className="w-fit"
