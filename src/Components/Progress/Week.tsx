...
export const Week = ({
	...
	return (
		<div
			className={isactive ? "block" : "hidden" + " absolute bg-gray-200 lg:w-10/12 lg:px-10 px-4 py-5 left-0 top-5 w-11/12"}
		>
			<div
				className={weeknumber === 2 ? "absolute lg:top-32 lg:left-96 top-44 left-32" : "hidden"}
			>
				<WeekSvg />
			...
			<div
				className={weeknumber === 2 ? "blur-sm pointer-events-none" : ""}
			>
