      ...
      <div className="px-4 py-8 sm:py-12 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto mb-8 sm:mb-12 px-4">
            Your personal fitness journey starts here. Join your gym by scanning their QR code.
          </p>
          {renderButton()}
          <div
...
const features = [
  {
    ...
    description: 'Simply scan the QR code at your gym to get started with your fitness journey.',
    icon: QrCode,
  },
  {
  ...
  },
  {
    ...
    description: 'Get updates and notifications about your gym activities and schedules.',
    icon: ArrowRight,
  },
];
