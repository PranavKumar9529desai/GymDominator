      ...
      >
        ...
        >
          <div className="inline-flex w-36 h-16 -ml-6 ">
            <img className="object-cover mt-1 " src={GymdominatorLogo} alt="logo" />
          ...
          >
            ...
            >
              ...
              <g id="SVGRepo_iconCarrier">
                {' '}
                <path d="M4 18L20 18" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" />
                <path d="M4 12L20 12" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" />
                <path d="M4 6L20 6" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" />
              </g>
            </svg>
          </button>
          <div
...
const SideBar = ({
  ...
  useEffect(() => {
    // Empty effect cleanup
  }, []); // Remove isRotated dependency since it's not used
