...
export const TodayAttendance: React.FC<TodayAttendanceProps> = ({ streak, entryTime }) => {
    ...
    <div className=" bg-white rounded-lg shadow-lg p-6 max-w-sm mx-auto">
      ...
      <div className="flex items-center mb-6">
        <div className="relative w-24 h-24">
          <svg className="w-full h-full" viewBox="0 0 100 100" aria-labelledby="streak-circle">
            <title id="streak-circle">Streak Progress</title>
            <circle
