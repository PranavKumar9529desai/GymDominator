...
import { User, Phone, MapPin, Ruler, Weight, Utensils, ChevronDownIcon } from 'lucide-react';
...
export const HealthProfileForm = () => {
  ...
  const SendHealthProfileData = async () => {
    try {
      setisLoading(true);
      const response: AxiosResponse<UserHealthProfileResponseType> = await axios.post(
