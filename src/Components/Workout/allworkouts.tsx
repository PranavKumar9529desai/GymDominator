			...
			{isLoading ? (
				...
				>
					{filteredMuscles.map((muscle) => (
						...
						>
							<div className="cursor-pointer rounded-2xl overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 hover:border-blue-500 transition-all duration-300 shadow-lg hover:shadow-blue-500/20">
								...
								<div className="p-6">
									...
									<p className="text-gray-400 mb-4">
										Discover exercises targeting your{" "}
										{muscle.name.toLowerCase()} muscles
									</p>
