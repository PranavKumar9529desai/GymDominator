  ...
  const features = [
    {
      ...
      description: "Revolutionizing how gyms operate with cutting-edge technology and seamless integration."
    },
    {
    ...
    },
    {
      ...
      description: "Continuously evolving our platform to meet the changing needs of modern fitness facilities."
    }
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed">
                At GymNavigator, we're committed to revolutionizing how gyms operate. 
                Our platform brings together cutting-edge technology with user-friendly 
                design to create the most efficient gym management solution available.
              </p>
            </div>
