  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div
          className="absolute top-0 left-0 w-72 h-72 bg-blue-500 rounded-full filter blur-3xl"
        ...
        <div
          className="absolute bottom-0 right-0 w-72 h-72 bg-cyan-500 rounded-full filter blur-3xl"
          aria-label="Cyan Circle"
          role="img"
        >
          <title>Cyan Circle</title>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="text-left space-y-6">
              ...
              <p className="text-gray-300 text-lg">
                Whether you're running a boutique fitness studio or a large gym chain, our platform
                adapts to your needs. Get started in minutes with our easy-to-use QR system.
              </p>
