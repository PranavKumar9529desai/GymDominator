					...
					<div className="grid lg:grid-cols-2 gap-8 items-center">
						<div className="text-left space-y-6">
							...
							<p className="text-gray-300 text-lg">
								Whether you're running a boutique fitness studio or a large gym
								chain, our platform adapts to your needs. Get started in minutes
								with our easy-to-use QR system.
							</p>
