...
import { QrCodeIcon, ClipboardDocumentCheckIcon, ChartBarIcon, UserCircleIcon } from '@heroicons/react/24/outline';

const steps = [
  {
    step: 1,
    title: "Scan Onboarding QR",
    description: "Scan the QR code provided by your gym owner or trainer to get started with your fitness journey",
    icon: <QrCodeIcon className="w-6 h-6 text-white" />
  },
  {
    step: 2,
    title: "Health Profile Form",
    description: "Complete your health profile by providing essential information about your fitness goals and current status",
    icon: <ClipboardDocumentCheckIcon className="w-6 h-6 text-white" />
  },
  {
    step: 3,
    title: "View Your Plans",
    description: "Access your personalized diet and workout plans created specifically for your goals",
    icon: <ChartBarIcon className="w-6 h-6 text-white" />
  },
  {
    step: 4,
    title: "Mark Attendance",
    description: "Scan the attendance QR code at your gym to track your daily progress",
