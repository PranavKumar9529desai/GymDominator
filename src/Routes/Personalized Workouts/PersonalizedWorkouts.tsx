...
export default function PersonalizedWorkouts() {
	const [todayWorkout, setTodayWorkout] = useState<WorkoutSchedule | null>(
		null,
	);
					...
					>
						...
						<div>
							...
							<p className="text-gray-600 mb-6">
								Today is your body's time to rebuild and grow stronger. Rest
								days are an essential part of your fitness journey.
							</p>
						</div>
						...
						<div className="text-sm text-gray-500 bg-gray-50 p-4 rounded-lg">
							<p className="italic">
								"Recovery is not a break from training – it's an essential part
								of training."
							</p>
						</div>
					</motion.div>
