  ...
  const features = [
    {
      ...
      description:
        "Custom-tailored nutrition plans based on your goals and preferences",
      icon: "🍽️",
    },
    {
        ...
        >
          ...
          <div className="space-y-6">
            <h1 className="text-5xl font-extrabold text-gray-900 tracking-tight">
              Your{" "}
              <span className="text-indigo-600">Personalized Diet Plan</span>
            </h1>
            <div className="space-y-4">
              <p className="max-w-2xl mx-auto text-xl text-gray-600">
                Expertly crafted based on your health parameters and fitness
                goals
              </p>
              <p className="max-w-2xl mx-auto text-lg text-gray-500">
                Developed by nutrition experts and fine-tuned by your personal
                trainer. Feel free to discuss your plan and make adjustments
          ...
          <div className="mt-16 text-sm text-gray-500">
            <p>
              Your personalized diet plan will be tailored based on your profile
              and goals.
            </p>
