...
export default function AboutPersonalTrainer() {
  const trainerInfo = {
    ...
    specializations: ['Weight Training', 'HIIT', 'Nutrition Planning', 'Strength & Conditioning'],
  };
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {trainerInfo.timings.map((timing) => (
                    <div
                      key={timing.id || timing.time}
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {trainerInfo.specializations.map((spec) => (
                    <span
