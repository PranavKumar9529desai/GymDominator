/*
  ...
  - The values [UPPERBack] on the enum `MuscleGroupEnum` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "MuscleGroupEnum_new" AS ENUM ('CHEST', 'UpperBack', 'SHOULDERS', 'BICEPS', 'TRICEPS', 'UPPERBACK');
